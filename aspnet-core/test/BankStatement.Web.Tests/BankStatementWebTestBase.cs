...
{
    public abstract class BankStatementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BankStatementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BankStatementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BankStatementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BankStatementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BankStatementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BankStatementDbContext, Task<T>> func)
        {
            T result;
